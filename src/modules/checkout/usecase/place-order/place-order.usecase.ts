...
export default class PlaceOrderUseCase implements UseCaseInterface {
    ...
    async execute(input: PlaceOrderInputDto): Promise<PlaceOrderOutputDto> {
        ...
        const myClient = new Client({
            ...
            name: client.name,
            email: client.email,
            address: new Address(client.address.street, client.address.city, client.address.state, client.address.zipCode, client.address.number, client.address.complement)
        });
