...
describe("PlaceOrderUseCase unit test", () => {
    ...
    describe("getProducts method", () => {
        ...
        it("should return a product", async () => {
            ...
            expect(product.id).toEqual(new Id("0"));
            expect(product.name).toEqual("Product 0");
            expect(product.description).toEqual("Description 0");
            expect(product.salesPrice).toEqual(0);
